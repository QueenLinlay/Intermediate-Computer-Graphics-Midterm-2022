...
#pragma endregion 
		...
		//Acting as enemy, for testing enemy trigger and collider
		...
		GameObject::Sptr monkey2 = scene->CreateGameObject("Monkey 1");
		{
			...
			//Below is player control, still need to fix it kinda up but its working. 
			monkey2->Add<SimpleObjectController>();
			// Below is Auto Movement left to right depends how you facing the camera
			//monkey2->Add<SimpleAutoMovement>();
